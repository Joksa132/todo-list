          ...
          <div className="upcoming-tasks">
            <div className="list-tasks">
              ...
              {tomorrowTasks.length ? tomorrowTasks?.map(task => (
                ...
                <span style={{ marginTop: "10px", fontSize: "1.1rem", paddingLeft: "12px" }}>No tasks for tomorrow</span>
              }
            </div>
            <div className="list-tasks-bottom">
              <div className="this-week-tasks">
                ...
                {weekTasks.length ? weekTasks?.map(task => (
                  ...
                  <span style={{ marginTop: "10px", fontSize: "1.1rem", paddingLeft: "12px" }}>No tasks for this week not counting tomorrow</span>
                }
              </div>
              <div className="later-tasks">
                ...
                {laterTasks.length ? laterTasks?.map(task => (
                  ...
                  <span style={{ marginTop: "10px", fontSize: "1.1rem", paddingLeft: "12px" }}>No tasks later than this week</span>
                }
              </div>
            </div>
          </div>
